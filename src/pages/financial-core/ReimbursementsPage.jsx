...
import { FiSearch, FiMoreVertical, FiChevronLeft, FiChevronRight, FiPlus, FiClock, FiCheckCircle, FiFileText } from 'react-icons/fi';
...
export default function ReimbursementsPage() {
  ...
  const reimbursements = [
    { id: 'REIMB-001', employee: 'Sarah Johnson', date: 'Jan 28, 2026', amount: '$85.50', method: 'Direct Deposit', status: 'PAID' },
    { id: 'REIMB-002', employee: 'Mike Chen', date: 'Jan 27, 2026', amount: '$299.00', method: 'Check', status: 'Approved' },
    { id: 'REIMB-003', employee: 'Emily Rodriguez', date: 'Jan 26, 2026', amount: '$1,250.00', method: 'Direct Deposit', status: 'Pending' },
  ];
          ...
          <div className="ep-container">
            <div className="ep-page-header">
              <div className="header-text">
                ...
                <p>Manage employee reimbursements requests and payouts.</p>
              </div>
            </div>
            ...
            <div className="ep-metrics-grid">
              <div className="ep-metric-card">
                <div className="ep-metric-header">
                  <span className="ep-metric-label">Total Reimbursements</span>
                  <span className="ep-metric-icon blue"><FiFileText size={18} /></span>
                </div>
                <div className="ep-metric-value">$52,340</div>
                <p className="ep-metric-subtitle neutral">This year</p>
              </div>
              <div className="ep-metric-card">
                <div className="ep-metric-header">
                  <span className="ep-metric-label">Pending</span>
                  <span className="ep-metric-icon orange"><FiClock size={18} /></span>
                </div>
                <div className="ep-metric-value">$1,250</div>
                <p className="ep-metric-subtitle orange">1 pending</p>
              </div>
              <div className="ep-metric-card">
                <div className="ep-metric-header">
                  <span className="ep-metric-label">Paid This Month</span>
                  <span className="ep-metric-icon green"><FiCheckCircle size={18} /></span>
                </div>
                <div className="ep-metric-value">$3,845</div>
                <p className="ep-metric-subtitle green">18 reimbursements</p>
              </div>
              <div className="ep-metric-card">
                <div className="ep-metric-header">
                  <span className="ep-metric-label">Avg Processing Time</span>
                  <span className="ep-metric-icon teal"><FiClock size={18} /></span>
                </div>
                <div className="ep-metric-value">2.3 days</div>
