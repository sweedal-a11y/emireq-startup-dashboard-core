      ...
      case "company-info":
        return (
          <div className="profile-card">
            ...
            <p className="profile-card-subtitle">Core details about your startup and business modal</p>
            ...
            <div className="profile-info-rows">
              <div className="profile-info-row">
                <div className="contact-title-container">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-24px' }}>
                    <g clip-path="url(#clip0_12_854)">
                      ...
                      <path d="M6 12H10" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M6.66666 14.6667H9.33332" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
                  ...
                  <div className="profile-info-content">
                    ...
                    <div className="profile-info-value1">Solving ABC Problems</div>
                  </div>
                </div>
              </div>
              ...
              <div className="profile-info-row">
                <div className="contact-title-container">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"style={{ marginTop: '-24px' }}>
                    <path d="M2.99999 11C1.99999 11.84 1.66666 14.3334 1.66666 14.3334C1.66666 14.3334 4.15999 14 4.99999 13C5.47332 12.44 5.46666 11.58 4.93999 11.06C4.68086 10.8127 4.33952 10.6698 3.98147 10.6587C2.99999 11Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8 10L6 8.00002C6.35476 7.07964 6.80147 6.1974 7.33333 5.36669C8.11012 4.12468 9.19175 3.10206 10.4753 2.39608C11.7589 1.69011 13.2018 1.32427 14.6667 1.33336C14.6667 3.14669 14.1467 6.33336 10.6667 8.66669C9.82459 9.19917 8.93123 9.64585 8 10Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M5.99999 8.00003H2.66666C2.66666 8.00003 3.03332 5.98003 3.99999 5.33337C5.07999 4.61337 7.33332 5.33337 7.33332 5.33337" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8 10V13.3334C8 13.3334 10.02 12.9667 10.6667 12C11.3867 10.92 10.6667 8.66669 10.6667 8.66669" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  <div className="profile-info-content">
                    <div className="profile-info-label">PRODUCT DESCRIPTION</div>
                ...
                <div className="contact-title-container">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"style={{ marginTop: '-24px' }}>
                    <g clip-path="url(#clip0_12_873)">
                      <path d="M8.00001 14.6666C11.6819 14.6666 14.6667 11.6819 14.6667 7.99998C14.6667 4.31808 11.6819 1.33331 8.00001 1.33331C4.31811 1.33331 1.33334 4.31808 1.33334 7.99998C1.33334 11.6819 4.31811 14.6666 8.00001 14.6666Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M8 12C10.2091 12 12 10.2091 12 8C12 5.79086 10.2091 4 8 4C5.79086 4 4 5.79086 4 8C4 10.2091 5.79086 12 8 12Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M7.99999 9.33335C8.73637 9.33335 9.33332 8.7364 9.33332 8.00002C9.33332 7.26364 8.73637 6.66669 7.99999 6.66669C7.26361 6.66669 6.66666 7.26364 6.66666 8.00002C6.66666 8.7364 7.26361 9.33335 7.99999 9.33335Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
            ...
            <div className="profile-card">
              <div className="vision-info-rows">
                <div className="vision-info-row">
                  <div className="contact-title-container">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-24px' }}>
                      <path d="M3 17L7 13L10 16L17 9" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M13 9H17V13" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <div className="vision-info-content">
                      <div className="vision-info-label">SHORT-TERM VISION</div>
                      <div className="vision-info-subtitle">Your goals for the next 6–12 months</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="profile-card">
              <div className="vision-info-rows">
                <div className="vision-info-row">
                  <div className="contact-title-container">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"style={{ marginTop: '-24px' }}>
                      <path d="M1.5 12C3.5 7 8 4.5 12 4.5C16 4.5 20.5 7 22.5 12C20.5 17 16 19.5 12 19.5C8 19.5 3.5 17 1.5 12Z" stroke="#6B7280" strokeWidth="1.5"/>
        ...
        return (
          <div className="profile-card">
            <div className="founders-header">
              <div className="contact-title-container">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '-22px' }}>
<path d="M13.3334 17.5V15.8333C13.3334 14.9493 12.9822 14.1014 12.3571 13.4763C11.732 12.8512 10.8841 12.5 10.0001 12.5H5.00008C4.11603 12.5 3.26818 12.8512 2.64306 13.4763C2.01794 14.1014 1.66675 14.9493 1.66675 15.8333V17.5" stroke="#717182" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M13.3333 2.60666C14.048 2.79197 14.6811 3.20938 15.133 3.79338C15.5849 4.37738 15.8301 5.0949 15.8301 5.83333C15.8301 6.57175 15.5849 7.28927 15.133 7.87327C14.6811 8.45727 14.048 8.87468 13.3333 9.05999" stroke="#717182" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M18.3333 17.5V15.8333C18.3327 15.0948 18.0869 14.3773 17.6344 13.7936C17.1819 13.2099 16.5484 12.793 15.8333 12.6083" stroke="#717182" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7.50008 9.16667C9.34103 9.16667 10.8334 7.67428 10.8334 5.83333C10.8334 3.99238 9.34103 2.5 7.50008 2.5C5.65913 2.5 4.16675 3.99238 4.16675 5.83333C4.16675 7.67428 5.65913 9.16667 7.50008 9.16667Z" stroke="#717182" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                <div className="founders-header-text">
                  <h3 className="founders-header-title">Founders & Team</h3>
                  <p className="founders-header-subtitle">Information about your founding team and their expertise</p>
                </div>
              </div>
            </div>
            <div className="profile-divider"></div>
            ...
            <div className="founders-section">
              ...
              <div className="founders-item">
                ...
                <div className="founders-value">ABC Team's Founder's Strength</div>
              </div>
            </div>
          </div>
        );
...
<path d="M18.3332 5.83334L10.8407 10.6058C10.5864 10.7535 10.2976 10.8313 10.0036 10.8313C9.70956 10.8313 9.42076 10.7535 9.1665 10.6058L1.6665 5.83334" stroke="#717182" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16.6665 3.33334H3.33317C2.4127 3.33334 1.6665 4.07954 1.6665 5.00001V15C1.6665 15.9205 2.4127 16.6667 3.33317 16.6667H16.6665C17.587 16.6667 18.3332 15.9205 18.3332 15V5.00001C18.3332 4.07954 17.587 3.33334 16.6665 3.33334Z" stroke="#717182" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

              <h3 className="profile-card-title">Contact Information</h3>
            </div>
            <p className="profile-card-subtitle">How investors and partners can reach you</p>
            <div className="profile-divider"></div>
...
<path d="M8.00016 14.6666C11.6821 14.6666 14.6668 11.6819 14.6668 7.99998C14.6668 4.31808 11.6821 1.33331 8.00016 1.33331C4.31826 1.33331 1.3335 4.31808 1.3335 7.99998C1.3335 11.6819 4.31826 14.6666 8.00016 14.6666Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8.00016 1.33331C6.28832 3.13075 5.3335 5.51781 5.3335 7.99998C5.3335 10.4822 6.28832 12.8692 8.00016 14.6666C9.71201 12.8692 10.6668 10.4822 10.6668 7.99998C10.6668 5.51781 9.71201 3.13075 8.00016 1.33331Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M1.3335 8H14.6668" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
              ...
              <div className="contact-item">
                <div className="contact-item-container">
                  <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13.3332 6.66665C13.3332 9.99531 9.6405 13.462 8.4005 14.5326C8.28499 14.6195 8.14437 14.6665 7.99984 14.6665C7.85531 14.6665 7.71469 14.6195 7.59917 14.5326C6.35917 13.462 2.6665 9.99531 2.6665 6.66665C2.6665 5.25216 3.22841 3.8956 4.2286 2.89541C5.2288 1.89522 6.58535 1.33331 7.99984 1.33331C9.41433 1.33331 10.7709 1.89522 11.7711 2.89541C12.7713 3.8956 13.3332 5.25216 13.3332 6.66665Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 8.66669C9.10457 8.66669 10 7.77126 10 6.66669C10 5.56212 9.10457 4.66669 8 4.66669C6.89543 4.66669 6 5.56212 6 6.66669C6 7.77126 6.89543 8.66669 8 8.66669Z" stroke="#717182" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
      ...
      <div className="profile-header-card">
        ...
        <div className="profile-header-right">
          <button className="profile-edit-btn">
           <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 13.3333H14" stroke="#121212" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M10.9173 2.41467C11.1827 2.14928 11.5426 2.00018 11.9179 2.00018C12.2933 2.00018 12.6532 2.14928 12.9186 2.41467C13.184 2.68007 13.3331 3.04002 13.3331 3.41534C13.3331 3.79066 13.184 4.15061 12.9186 4.41601L4.91194 12.4233C4.75334 12.5819 4.55729 12.698 4.34194 12.7607L2.42728 13.3193C2.36991 13.3361 2.3091 13.3371 2.25122 13.3222C2.19333 13.3074 2.1405 13.2773 2.09824 13.235C2.05599 13.1928 2.02587 13.14 2.01104 13.0821C1.99621 13.0242 1.99721 12.9634 2.01394 12.906L2.57261 10.9913C2.63542 10.7762 2.75144 10.5804 2.90994 10.422L10.9173 2.41467Z" stroke="#121212" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
