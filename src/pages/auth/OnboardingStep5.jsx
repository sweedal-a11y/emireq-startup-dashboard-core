...
const OnboardingStep5 = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.companyStage || !formData.amountRaising) {
      return;
    }
  ...
  const fundingStages = [
    { value: 'pre-seed', label: 'Pre-Seed', range: '$50k-$500k' },
    { value: 'seed', label: 'Seed Round', range: '$500k-$2m' },
    { value: 'series-a', label: 'Series A', range: '$2M-$15M' },
    { value: 'series-b', label: 'Series B', range: '$15M+' }
  ];

  const isFormValid = () => {
    return formData.companyStage && formData.amountRaising;
  };

  return (
    <div className="onboarding-container-step5">
      {/* Left Side - Branding */}
      <div className="onboarding-left-step5">
        <div className="onboarding-left-header-step5">
          <div className="trust-badge-onboarding-step5">
            <TrustBadgeIcon />
            <span>Trusted by 50,000+ users worldwide</span>
          </div>

          <div className="language-selector-onboarding-step5">
        ...
        <div className="onboarding-content-step5">
          <div className="step-badge-step5">
            Step 5 of 9
          </div>

          <h1 className="onboarding-title-step5">Secure Your Funding</h1>

          <div className="quote-icon-onboarding-step5">
          ...
          <p className="onboarding-description-step5">
            Clear funding goals help investors understand your vision and growth plans.
          </p>

          <div className="onboarding-features-step5">
            <div className="onboarding-feature-item-step5">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.6667 5L7.50004 14.1667L3.33337 10" stroke="#FFC300" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <span>Match with right investors</span>
            </div>
            <div className="onboarding-feature-item-step5">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.6667 5L7.50004 14.1667L3.33337 10" stroke="#FFC300" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      {/* Right Side - Form */}
      <div className="onboarding-right-step5">
        <div className="onboarding-right-header-step5">
          <img src={emireqLogo} alt="Emireq Logo" className="onboarding-logo-step5" />
          
          <div className="language-selector-right-step5">
            <span>English(UK)</span>
            <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="progress-stepper-step5">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((step) => (
            <React.Fragment key={step}>
              <div className={`progress-step-step5 ${step === 5 ? 'active' : ''} ${step < 5 ? 'completed' : ''}`}>
                {step < 5 ? (
              ...
              {step < 9 && <div className="progress-line-step5"></div>}
            </React.Fragment>
          ))}
        </div>

        <div className="onboarding-form-section-step5">
          <div className="form-header-step5">
            <div className="form-icon-step5">
             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 1.33334V14.6667" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M11.3333 3.33334H6.33333C5.71449 3.33334 5.121 3.57918 4.68342 4.01676C4.24583 4.45435 4 5.04784 4 5.66668C4 6.28552 4.24583 6.87901 4.68342 7.31659C5.121 7.75418 5.71449 8.00001 6.33333 8.00001H9.66667C10.2855 8.00001 10.879 8.24584 11.3166 8.68343C11.7542 9.12101 12 9.7145 12 10.3333C12 10.9522 11.7542 11.5457 11.3166 11.9833C10.879 12.4208 10.2855 12.6667 9.66667 12.6667H4" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

            </div>
            <h2 className="form-title-step5">Funding Information</h2>
          </div>

          <p className="form-subtitle-step5">
            Tell us about your funding needs and goals
          </p>

          <form onSubmit={handleSubmit} className="onboarding-form-step5">
            <div className="form-group-step5">
              <label className="form-label-step5">What stage is your company at?</label>
              <div className="radio-group-step5">
                {fundingStages.map((stage) => (
                  <div 
                    key={stage.value}
                    className={`radio-option-step5 ${formData.companyStage === stage.value ? 'selected' : ''}`}
                    onClick={() => handleStageChange(stage.value)}
                  >
                    <div className="radio-button-step5">
                      {formData.companyStage === stage.value && <div className="radio-inner-step5"></div>}
                    </div>
                    <div className="radio-label-step5">
                      <span className="stage-name-step5">{stage.label}</span>
                      <span className="stage-range-step5">{stage.range}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="form-group-step5">
              <label htmlFor="amountRaising" className="form-label-step5">Amount Raising</label>
              <input
                type="text"
                id="amountRaising"
                className="form-input-step5"
