...
import { getPreview } from "../../apiCalls/startupAPI/startupAPICall";
import { STARTUP_PREVIEW } from "../../services/endPoints";
      ...
      <div className="onboarding-left">
        ...
        <div className="onboarding-content">
          ...
          <p className="onboarding-description">
            Help investors understand your business by providing accurate
            company information. This builds trust and credibility.
          </p>
            ...
            <div className="form-icon">
              ...
              >
                <g clip-path="url(#clip0_115_13377)">
                  ...
                  />
                  <path
                    d="M3.99992 8H2.66659C2.31296 8 1.97382 8.14048 1.72378 8.39052C1.47373 8.64057 1.33325 8.97971 1.33325 9.33333V13.3333C1.33325 13.687 1.47373 14.0261 1.72378 14.2761C1.97382 14.5262 2.31296 14.6667 2.66659 14.6667H3.99992"
                    stroke="white"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  ...
                  />
                  <path
                    d="M6.66675 4H9.33341"
                    stroke="white"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M6.66675 6.66669H9.33341"
                    stroke="white"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M6.66675 9.33334H9.33341"
                    stroke="white"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
            ...
            <div className="onboarding-form-group">
              ...
              <div className="input-with-icon">
                ...
                >
                  ...
                  <path
                    d="M10 2C12 4.5 13 7.5 13 10C13 12.5 12 15.5 10 18C8 15.5 7 12.5 7 10C7 7.5 8 4.5 10 2Z"
                    stroke="#9CA3AF"
                    strokeWidth="1.5"
                  />
                </svg>
