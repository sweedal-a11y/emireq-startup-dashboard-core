...
const OnboardingStep4 = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.businessDescription || !formData.problemSolving || !formData.targetMarket || !formData.revenueModel) {
      return;
    }
  ...
  const revenueModels = [
    { value: '', label: 'Select your revenue model' },
  ...
  const isFormValid = () => {
    return formData.businessDescription && formData.problemSolving && formData.targetMarket && formData.revenueModel;
  };

  return (
    <div className="onboarding-container-step4">
      {/* Left Side - Branding */}
      <div className="onboarding-left-step4">
        <div className="onboarding-left-header-step4">
          <div className="trust-badge-onboarding-step4">
            <TrustBadgeIcon />
            <span>Trusted by 50,000+ users worldwide</span>
          </div>

          <div className="language-selector-onboarding-step4">
        ...
        <div className="onboarding-content-step4">
          <div className="step-badge-step4">
            Step 4 of 9
          </div>

          <h1 className="onboarding-title-step4">Show Your Business Model</h1>

          <div className="quote-icon-onboarding-step4">
          ...
          <p className="onboarding-description-step4">
            Clear revenue models and growth potential are key to attracting investors
          </p>
        </div>
      </div>

      {/* Right Side - Form */}
      <div className="onboarding-right-step4">
        <div className="onboarding-right-header-step4">
          <img src={emireqLogo} alt="Emireq Logo" className="onboarding-logo-step4" />
          
          <div className="language-selector-right-step4">
            <span>English(UK)</span>
            <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="progress-stepper-step4">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((step) => (
            <React.Fragment key={step}>
              <div className={`progress-step-step4 ${step === 4 ? 'active' : ''} ${step < 4 ? 'completed' : ''}`}>
                {step < 4 ? (
              ...
              {step < 9 && <div className="progress-line-step4"></div>}
            </React.Fragment>
          ))}
        </div>

        <div className="onboarding-form-section-step4">
          <div className="form-header-step4">
            <div className="form-icon-step4">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 className="form-title-step4">Business Model</h2>
          </div>

          <p className="form-subtitle-step4">
            Explain how your startup creates and captures value
          </p>

          <form onSubmit={handleSubmit} className="onboarding-form-step4">
            <div className="form-group-step4">
              <label htmlFor="businessDescription" className="form-label-step4">Business Description</label>
              <textarea
                id="businessDescription"
                className="form-textarea-step4"
            ...
            <div className="form-group-step4">
              <label htmlFor="problemSolving" className="form-label-step4">What problem are you solving?</label>
              <textarea
                id="problemSolving"
                className="form-textarea-step4"
            ...
            <div className="form-group-step4">
              <label htmlFor="targetMarket" className="form-label-step4">Target Market</label>
              <input
                type="text"
                id="targetMarket"
                className="form-input-step4"
            ...
            <div className="form-group-step4">
              <label htmlFor="revenueModel" className="form-label-step4">Revenue Modal</label>
              <select
                id="revenueModel"
                className="form-select-step4"
